		...
		<div class="container" style="background:url('clients.jpg');background-repeat: no-repeat;background-size: cover;height:600px">
			...
			<div class="row">
				...
				<div class="col-md-3 text-center">
					<img src="<?php echo e(asset('img/customers/1.png')); ?>" class="img-responsive" />
				</div>
				<div class="col-md-3 text-center">
					<img src="<?php echo e(asset('img/customers/2.jpg')); ?>" class="img-responsive" />
				</div>
				<div class="col-md-3 text-center">
					<img src="<?php echo e(asset('img/customers/3.png')); ?>" class="img-responsive" />
				</div>
				<div class="col-md-3 text-center">
					<img src="<?php echo e(asset('img/customers/4.png')); ?>" class="img-responsive" />
				</div>
