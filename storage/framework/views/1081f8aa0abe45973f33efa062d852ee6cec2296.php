<head>
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('css/demos/demo-medical.css')); ?>">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('css/skins/skin-medical.css')); ?>">		<script src="<?php echo e(asset('master/style-switcher/style.switcher.localstorage.js')); ?>"></script> 
